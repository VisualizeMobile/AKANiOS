...
-(void)loadParliamentariesTestData
{
    ...
    [parliamentaryDao insertParliamentaryWithNickName:@"FRANCISCO TENORIO" andFullName:@"José Francisco Cerqueira Tenório" andIdParliamentary:@"141467" andParty:@"PMN" andPosRanking:@2 andUf:@"AL" andUrlPhoto:@"http://www.camara.gov.br/internet/deputado/bandep/141467.jpg" andValueRanking:@3000 andIdUpdate:@01 andFollowed:@0];
    
    [parliamentaryDao insertParliamentaryWithNickName:@"PAULÃO" andFullName:@"PAULO FERNANDO DOS SANTOS" andIdParliamentary:@"171617" andParty:@"PT" andPosRanking:@03 andUf:@"AL" andUrlPhoto:@"http://www.camara.gov.br/internet/deputado/bandep/171617.jpg" andValueRanking:@2000 andIdUpdate:@01 andFollowed:@0];
    
    [parliamentaryDao insertParliamentaryWithNickName:@"TIRIRICA" andFullName:@"FRANCISCO EVERARDO OLIVEIRA SILVA" andIdParliamentary:@"160976" andParty:@"PR" andPosRanking:@4 andUf:@"SP" andUrlPhoto:@"http://www.camara.gov.br/internet/deputado/bandep/160976.jpg" andValueRanking:@1212 andIdUpdate:@0 andFollowed:@0];
    
    [parliamentaryDao insertParliamentaryWithNickName:@"JAIR BOLSONARO" andFullName:@"AIR MESSIAS BOLSONARO" andIdParliamentary:@"74847" andParty:@"PP" andPosRanking:@1 andUf:@"RJ" andUrlPhoto:@"http://www.camara.gov.br/internet/deputado/bandep/74847.jpg" andValueRanking:@10000 andIdUpdate:@1 andFollowed:@0];
